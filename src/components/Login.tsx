    ...
    try {
      ...
      if (!userDoc.exists()) {
        ...
        const collectionName =
          finalRole === "business" ? "businessUsers" : "customerUsers";
      ...
      <div className="flex flex-col items-center gap-8 p-8 max-w-6xl mx-auto">
        <div className="text-center mb-6">
          ...
          <p className="text-lg text-gray-600 mb-6 max-w-2xl mx-auto">
            Choose how you'd like to participate. Don't worry - you can always
            change this later!
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-5xl">
          <button
            ...
            disabled={loading}
            className="p-8 border-2 border-gray-200 rounded-xl hover:border-blue-500 hover:bg-blue-50 transition-all text-left disabled:opacity-50 group h-full flex flex-col"
          >
            ...
            <p className="text-gray-600 mb-6 flex-grow">
              Perfect for discovering and contributing to local sustainable
              businesses
            </p>
          ...
          <button
            ...
            disabled={loading}
            className="p-8 border-2 border-gray-200 rounded-xl hover:border-green-500 hover:bg-green-50 transition-all text-left disabled:opacity-50 group h-full flex flex-col"
          >
            <div className="flex items-center gap-4 mb-6">
        ...
        <div className="text-center text-gray-500 mt-6 max-w-2xl">
          <p className="text-base">
            By signing up, you're helping build a community-driven platform for
